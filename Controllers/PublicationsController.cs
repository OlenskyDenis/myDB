    ...
    public class PublicationsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Publication != null ? 
                          ...
                          Problem("Entity set 'myDBContext.Publication'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description")] Publication publication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description")] Publication publication)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'myDBContext.Publication'  is null.");
            }
            var publication = await _context.Publication.FindAsync(id);
            if (publication != null)
            {
